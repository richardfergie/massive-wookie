...
var _user$project$Generated_Types$Submitted = {ctor: 'Submitted'};
var _user$project$Generated_Types$Created = {ctor: 'Created'};

var _user$project$Helpers_Types$stringToProjectStatus = function (x) {
	var _p0 = x;
	switch (_p0) {
		case 'Created':
			return _elm_lang$core$Result$Ok(_user$project$Generated_Types$Created);
		case 'Submitted':
			return _elm_lang$core$Result$Ok(_user$project$Generated_Types$Submitted);
		case 'Validated':
			return _elm_lang$core$Result$Ok(_user$project$Generated_Types$Validated);
		case 'Granted':
			return _elm_lang$core$Result$Ok(_user$project$Generated_Types$Granted);
		default:
			return _elm_lang$core$Result$Err('Unknown project status');
	}
};
var _user$project$Helpers_Types$decodeProjectStatus = A2(
	_elm_lang$core$Json_Decode$andThen,
	_user$project$Generated_Types$resultToDecoder,
...
var _user$project$Helpers_Types$displayMessage = function (f) {
	var _p1 = f.message;
	if (_p1.ctor === 'Nothing') {
		return A2(
...
var _user$project$Helpers_Types$initialForm = function (i) {
	return A2(_user$project$Helpers_Types$Form, i, _elm_lang$core$Maybe$Nothing);
};
var _user$project$Helpers_Types$Entity = F2(
	function (a, b) {
		return {entityKey: a, entityVal: b};
	});
var _user$project$Helpers_Types$decodeEntity = function (dec) {
	return A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'entityVal',
		dec,
		A3(
			...
			'entityKey',
			_elm_lang$core$Json_Decode$int,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Helpers_Types$Entity)));
};
var _user$project$Helpers_Types$UserCreds = F4(
	function (a, b, c, d) {
		return {userCredsId: a, userCredsUsername: b, userCredsExpires: c, userCredsIssued: d};
	});
var _user$project$Helpers_Types$decodeUserCreds = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'_userCredsIssued',
...
var _user$project$Component_GroupMember$loadGroupMemberHttp = F2(
	function (jwt, i) {
...
var _user$project$Component_GroupMember$startDate = A7(
	...
	2000,
	_rluiten$elm_date_extra$Date_Extra_Core$intToMonth(1),
	1,
	0,
	0,
	0,
...
var _user$project$Component_GroupMember$UpdateLastname = function (a) {
	return {ctor: 'UpdateLastname', _0: a};
};
var _user$project$Component_GroupMember$UpdateFirstname = function (a) {
	return {ctor: 'UpdateFirstname', _0: a};
};
var _user$project$Component_GroupMember$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
								...
								_1: {
									...
									_1: {
										...
										_0: _elm_lang$html$Html_Attributes$value(
											A3(_rluiten$elm_date_extra$Date_Extra_Format$format, _rluiten$elm_date_extra$Date_Extra_Config_Config_en_gb$config, '%Y-%m-%d', model.dob)),
										_1: {ctor: '[]'}
									}
								}
							},
...
var _user$project$Component_Group$loadGroupHttp = F2(
	function (jwt, i) {
		return _elm_lang$http$Http$toTask(
			_elm_lang$http$Http$request(
				{
...
var _user$project$Component_Group$groupSize = function (g) {
	return _elm_lang$core$Dict$size(g.members);
};
var _user$project$Component_Group$traceDecoder = F2(
			...
			function (value) {
				...
				if (_p6.ctor === 'Ok') {
					...
					return _elm_lang$core$Json_Decode$fail(
						A2(_elm_lang$core$Debug$log, message, _p6._0));
				}
			})(_elm_lang$core$Json_Decode$value);
	});
var _user$project$Component_Group$viewSelectOptions = F2(
	function (i, d) {
		var isSelected = function (k) {
			return _elm_lang$html$Html_Attributes$selected(
				_elm_lang$core$Native_Utils.eq(k, i));
		};
		var ls = _elm_lang$core$Dict$toList(d);
		return A2(
			_elm_lang$core$List$map,
			function (_p7) {
				var _p8 = _p7;
				...
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(_p8._1.organisationName),
						_1: {ctor: '[]'}
					});
			},
			ls);
...
var _user$project$Component_Group$loadGroup = F2(
	function (jwt, i) {
		return A2(
			_elm_lang$core$Task$andThen,
			function (wiregroup) {
				return A2(
					...
					function (dict) {
						return _elm_lang$core$Task$succeed(
							A2(_user$project$Component_Group$fromWireGroup, dict, wiregroup));
					},
					A2(
						_elm_lang$core$Task$map,
						function (_p10) {
							return _elm_lang$core$Dict$fromList(
								_user$project$Component_Group$addNumbers(_p10));
						},
						_elm_lang$core$Task$sequence(
							A2(
								_elm_lang$core$List$map,
								_user$project$Component_GroupMember$loadGroupMemberHttp(jwt),
								wiregroup.members))));
			},
			A2(_user$project$Component_Group$loadGroupHttp, jwt, i));
	});
var _user$project$Component_Group$ChangeView = function (a) {
	return {ctor: 'ChangeView', _0: a};
};
var _user$project$Component_Group$LoadGroup = function (a) {
	return {ctor: 'LoadGroup', _0: a};
};
...
var _user$project$Component_Group$update = F4(
	function (jwt, _p12, msg, model) {
		...
		switch (_p13.ctor) {
			...
			case 'RemoveGroupMember':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							members: A2(_elm_lang$core$Dict$remove, _p13._0, members)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'UpdateGroupMember':
				...
				var r = A2(
					...
					function (x) {
						return A3(_user$project$Component_GroupMember$update, jwt, _p13._1, x);
					},
					A2(_elm_lang$core$Dict$get, _p15, members));
				var _p14 = r;
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								members: A3(
									_elm_lang$core$Dict$insert,
									_p15,
									_elm_lang$core$Tuple$first(_p14._0),
									members)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
			...
			case 'SetGroup':
				if (_p13._0.ctor === 'Success') {
					return {ctor: '_Tuple2', _0: _p13._0._0, _1: _elm_lang$core$Platform_Cmd$none};
				} else {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			...
			case 'LoadGroup':
				return {
					...
					_1: A2(
						...
						function (_p16) {
							return _user$project$Component_Group$SetGroup(
								_krisajenkins$remotedata$RemoteData$fromResult(_p16));
						},
						A2(_user$project$Component_Group$loadGroup, jwt, _p13._0))
				};
			default:
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
var _user$project$Component_Group$loadGroupCmd = F2(
	function (jwt, i) {
		return A2(
			_elm_lang$core$Task$attempt,
			function (_p17) {
			...
			A2(_user$project$Component_Group$loadGroup, jwt, i));
	});
...
var _user$project$Component_Group$AddGroupMember = {ctor: 'AddGroupMember'};
var _user$project$Component_Group$UpdateOrganisation = function (a) {
	return {ctor: 'UpdateOrganisation', _0: a};
};
var _user$project$Component_Group$selectEvent = A2(
	_elm_lang$html$Html_Events$on,
	'change',
	A2(
		_elm_lang$core$Json_Decode$map,
		_user$project$Component_Group$UpdateOrganisation,
		A2(
			_elm_lang$core$Json_Decode$andThen,
			function (val) {
				var _p18 = _elm_lang$core$String$toInt(val);
				if (_p18.ctor === 'Err') {
					return _elm_lang$core$Json_Decode$fail('Not an integer');
				} else {
					return _elm_lang$core$Json_Decode$succeed(_p18._0);
				}
			},
			_elm_lang$html$Html_Events$targetValue)));
var _user$project$Component_Group$UpdateGroupMember = F2(
	function (a, b) {
		return {ctor: 'UpdateGroupMember', _0: a, _1: b};
	});
var _user$project$Component_Group$viewGroupMembers = function (d) {
	return A3(
		_elm_lang$core$Dict$foldl,
		F3(
			function (k, v, acc) {
							...
							_0: A2(
								_elm_lang$html$Html$button,
								{
									...
									_0: _elm_lang$html$Html_Events$onClick(
										_user$project$Component_Group$RemoveGroupMember(k)),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
...
var _user$project$Component_Group$view = F2(
	function (morgs, model) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$placeholder('Group name'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onInput(_user$project$Component_Group$UpdateGroupName),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$value(model.groupName),
								_1: {ctor: '[]'}
							}
						}
					},
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Group organisation: '),
							_1: {
								ctor: '::',
								_0: function () {
									var _p19 = morgs;
									if (_p19.ctor === 'Nothing') {
										return _elm_lang$html$Html$text('Unable to get org link');
									} else {
										return A2(
											_elm_lang$html$Html$select,
											{
												ctor: '::',
												_0: _user$project$Component_Group$selectEvent,
												_1: {ctor: '[]'}
											},
											A2(_user$project$Component_Group$viewSelectOptions, model.organisation, _p19._0));
									}
								}(),
								_1: {ctor: '[]'}
							}
					...
					_1: {
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: _elm_lang$html$Html$text(
											_elm_lang$core$Basics$toString(
												_elm_lang$core$Dict$size(model.members))),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
						...
						_1: {
							...
							_0: A2(
								_elm_lang$html$Html$div,
								{ctor: '[]'},
								_user$project$Component_Group$viewGroupMembers(model.members)),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$div,
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(_user$project$Component_Group$AddGroupMember),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
								...
								_1: {
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											ctor: '::',
											_0: function () {
												var _p20 = _user$project$Component_Group$groupSize(model);
												if (_p20 === 0) {
													return A2(
														_elm_lang$html$Html$button,
														{ctor: '[]'},
...
var _user$project$Component_Login$validateLogin = function (res) {
	var _p0 = res;
	if (_p0.ctor === 'Err') {
		switch (_p0._0.ctor) {
			case 'BadUrl':
...
var _user$project$Component_Login$attemptLogin = F2(
	function (uname, pword) {
		var obj = _elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'username',
					_1: _elm_lang$core$Json_Encode$string(uname)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'password',
						_1: _elm_lang$core$Json_Encode$string(pword)
					},
					_1: {ctor: '[]'}
				}
			});
		return A2(
			_elm_lang$http$Http$send,
			_user$project$Component_Login$validateLogin,
			A3(
				_elm_lang$http$Http$post,
				'http://localhost:8080/auth/login',
				_elm_lang$http$Http$jsonBody(obj),
				_elm_lang$core$Json_Decode$string));
	});
...
var _user$project$Component_Login$UpdatePassword = function (a) {
	return {ctor: 'UpdatePassword', _0: a};
};
var _user$project$Component_Login$UpdateUsername = function (a) {
	return {ctor: 'UpdateUsername', _0: a};
};
var _user$project$Component_Login$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _user$project$Component_Login$main = _elm_lang$html$Html$program(
	{
...
var _user$project$Component_Overview$ChangeView = function (a) {
	return {ctor: 'ChangeView', _0: a};
};
...
var _user$project$Component_Project$UpdateName = function (a) {
	return {ctor: 'UpdateName', _0: a};
};
var _user$project$Component_Project$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: A2(_elm_lang$html$Html_Attributes$attribute, 'rows', '20'),
								_1: {
									ctor: '::',
									_0: A2(_elm_lang$html$Html_Attributes$attribute, 'cols', '60'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$placeholder('Project description'),
										_1: {
											ctor: '::',
...
var _user$project$Main$idListToDict = function (ls) {
	var foo = function (x) {
		var _p0 = x.id;
		if (_p0.ctor === 'Nothing') {
			return _elm_lang$core$Maybe$Nothing;
			...
			return _elm_lang$core$Maybe$Just(
				{ctor: '_Tuple2', _0: _p0._0, _1: x});
		}
	};
	return _elm_lang$core$Dict$fromList(
		A2(_elm_lang$core$List$filterMap, foo, ls));
};
...
var _user$project$Main$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {group: a, project: b, login: c, overview: d, view: e, user: f, facilitatorOrganisations: g, messages: h};
	});
var _user$project$Main$model = A8(
	_user$project$Main$Model,
	_elm_lang$core$Maybe$Nothing,
	_elm_lang$core$Maybe$Nothing,
	A2(_user$project$Component_Login$Model, '', ''),
	_elm_lang$core$Tuple$first(_user$project$Component_Overview$init),
	_user$project$Helpers_Types$LoginView,
	_elm_lang$core$Maybe$Nothing,
	_elm_lang$core$Maybe$Nothing,
	{ctor: '[]'});
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									_elm_lang$html$Html$a,
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											_user$project$Main$ChangeView(_user$project$Helpers_Types$OverviewView)),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
...
var _user$project$Main$UpdateOrganisations = function (a) {
	return {ctor: 'UpdateOrganisations', _0: a};
};
var _user$project$Main$getFacilitatorOrganisations = function (jwt) {
	return A2(
		_elm_lang$core$Task$attempt,
		function (res) {
			var _p2 = res;
			if (_p2.ctor === 'Err') {
				return _user$project$Main$UpdateOrganisations(_elm_lang$core$Maybe$Nothing);
			} else {
				return _p2._0;
			}
		},
		A2(
			_elm_lang$core$Task$map,
			function (_p3) {
				return _user$project$Main$UpdateOrganisations(
					_elm_lang$core$Maybe$Just(_p3));
			},
			A2(
				_elm_lang$core$Task$map,
				_user$project$Main$idListToDict,
					...
					_elm_lang$http$Http$request(
						{
							...
							body: _elm_lang$http$Http$emptyBody,
							expect: _elm_lang$http$Http$expectJson(
								_elm_lang$core$Json_Decode$list(_user$project$Generated_Types$decodeOrganisation)),
							headers: {
								ctor: '::',
								_0: A2(_elm_lang$http$Http$header, 'authorization', jwt),
								_1: {ctor: '[]'}
	...
	return A2(
		...
		function () {
			...
			if (_p4.ctor === 'Nothing') {
				...
				return _user$project$Component_Project$view(_p4._0);
			}
		}());
};
		...
		switch (_p5.ctor) {
			case 'Tick':
				...
				var newmessages = A2(
					...
					function (x) {
						return _elm_lang$core$Native_Utils.cmp(x.messageExpires, _p5._0) > 0;
					},
					oldmessages);
				return {
					ctor: '_Tuple2',
			...
			case 'Logout':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{user: _elm_lang$core$Maybe$Nothing, view: _user$project$Helpers_Types$LoginView}),
					_1: A2(
						_elm_lang$core$Platform_Cmd$map,
						function (_p6) {
							return _user$project$Main$UpdateLogin(
								_user$project$Component_Login$Message(_p6));
						},
						A3(_user$project$Helpers_Types$generateMessage, _user$project$Helpers_Types$Standard, 'Logged out', 3))
				};
			case 'UpdateGroup':
				if (_p5._0.ctor === 'ChangeView') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
					...
					var orgid = A2(
						...
						_elm_lang$core$List$head(
							_elm_lang$core$Dict$keys(
								A2(_elm_lang$core$Maybe$withDefault, _elm_lang$core$Dict$empty, model.facilitatorOrganisations))));
					var jwt = A2(
						_elm_lang$core$Maybe$withDefault,
						'',
						A2(
					...
					var _p7 = A4(
						...
						jwt,
						model.facilitatorOrganisations,
						_p5._0,
						A2(
							_elm_lang$core$Maybe$withDefault,
			...
			case 'UpdateLogin':
				switch (_p5._0.ctor) {
					case 'Message':
						var newmessages = {ctor: '::', _0: _p5._0._0, _1: model.messages};
						var oldmessages = model.messages;
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
					...
					case 'AddGroup':
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									view: _user$project$Helpers_Types$GroupView(_elm_lang$core$Maybe$Nothing),
			...
			case 'UpdateOrganisations':
				if (_p5._0.ctor === 'Nothing') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{facilitatorOrganisations: _p5._0}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			default:
...
var _user$project$Main$groupView = F2(
	function (orgs, g) {
		var orgid = A2(
			_elm_lang$core$Maybe$withDefault,
			0,
			_elm_lang$core$List$head(
				_elm_lang$core$Dict$keys(
					A2(_elm_lang$core$Maybe$withDefault, _elm_lang$core$Dict$empty, orgs))));
		return A2(
			_elm_lang$html$Html$map,
			_user$project$Main$UpdateGroup,
			function () {
						...
						switch (_p20.ctor) {
							case 'GroupView':
								return A2(
									...
									{
										ctor: '::',
										_0: A2(_user$project$Main$groupView, m.facilitatorOrganisations, m.group),
										_1: {ctor: '[]'}
									});
							case 'ProjectView':
								return A2(
