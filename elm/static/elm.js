...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {group: a, project: b, view: c};
	});
var _user$project$Main$ProjectView = {ctor: 'ProjectView'};
var _user$project$Main$GroupView = {ctor: 'GroupView'};
var _user$project$Main$model = A3(_user$project$Main$Model, _elm_lang$core$Maybe$Nothing, _elm_lang$core$Maybe$Nothing, _user$project$Main$GroupView);
	...
	return A2(
		...
		function () {
			...
			if (_p3.ctor === 'Nothing') {
				...
				return _user$project$Component_Group$view(_p3._0);
			}
		}());
};
var _user$project$Main$view = function (m) {
	var _p4 = m.view;
	if (_p4.ctor === 'GroupView') {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
				...
				_1: {
					ctor: '::',
					_0: function () {
						var _p5 = _user$project$Main$groupSize(m.group);
						if (_p5 === 0) {
							return A2(
								_elm_lang$html$Html$button,
								{ctor: '[]'},
